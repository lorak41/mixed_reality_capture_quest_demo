...
/// </summary>
public class AdvancedMeshSeq : MonoBehaviour {

	public bool PingPong = false; //ping pong sequence
	public float PlaybackSpeed = 30.0f; //framerate of sequence playback
	public int StartFrame =0; //starting frame of sequence playback
	private Material NewMaterial; //starting frame of sequence playback
    ...
    foreach (Transform child in transform)
    {
      ...
      string obj_name = child.gameObject.name.ToString();
      Debug.Log("OBJ name is: " + obj_name);
      Renderer[] children = child.gameObject.GetComponentsInChildren<Renderer>();
      foreach (Renderer rend in children)
      {
        var mats = new Material[rend.materials.Length];
				
        NewMaterial = Resources.Load<Material>("Materials/" + obj_name);
